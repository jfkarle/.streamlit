...
# In your app.py, just after `load_all_data_from_sheets()`
if ecm.LOADED_CUSTOMERS:
    first_customer = ecm.LOADED_CUSTOMERS[0]
    st.sidebar.write(f"🔍 Keys of first customer record: {list(first_customer.keys())}")
